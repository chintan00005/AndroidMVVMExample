package com.example.mvvmloginexample.browsablePage.view.ui.tools
...
import com.example.mvvmloginexample.databinding.FragmentAboutusBinding


class ToolsFragment : Fragment() {

    private lateinit var toolsViewModel: ToolViewModel
